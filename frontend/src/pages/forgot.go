		...
		app.Div().Body(
			app.Div().Class("grid grid-cols-2").Body(
				app.Form().Class("xl:col-span-2 md:col-span-1 col-span-2 max-w-[30rem] xl:mx-auto").Body(
					...
					app.Button().Disabled(f.loading).Text("Send OTP").Class("px-3 py-2 bg-purple-500 hover:bg-purple-800 text-white rounded-md mt-6 dark:bg-purple-600 dark:hover:bg-purple-400").OnClick(f.submit),
